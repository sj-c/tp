...
public class AddMemberCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE
            ...
            + EMAIL_DESC_BOB
            + MATRIC_DESC_BOB
            + TAG_DESC_FRIEND, new AddMemberCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB
            ...
            + MATRIC_DESC_BOB
            + TAG_DESC_HUSBAND
            + TAG_DESC_FRIEND, new AddMemberCommand(expectedPersonMultipleTags));
    }
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser, MATRIC_DESC_AMY
        ...
        assertParseFailure(parser, validExpectedPersonString
            ...
            + MATRIC_DESC_AMY
            + validExpectedPersonString, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME,
            PREFIX_MATRICULATIONNUMBER, PREFIX_EMAIL, PREFIX_PHONE));
        ...
        assertParseFailure(parser, INVALID_MATRIC_DESC
                + validExpectedPersonString,
            Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MATRICULATIONNUMBER));

        // valid value followed by invalid value
        assertParseFailure(parser, validExpectedPersonString
            + INVALID_NAME_DESC, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME));

        assertParseFailure(parser, validExpectedPersonString
            + INVALID_EMAIL_DESC, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_EMAIL));

        assertParseFailure(parser, validExpectedPersonString
            + INVALID_PHONE_DESC, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE));

        assertParseFailure(parser, validExpectedPersonString
            + INVALID_MATRIC_DESC, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_MATRICULATIONNUMBER));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY
            + PHONE_DESC_AMY
            + EMAIL_DESC_AMY
            + MATRIC_DESC_AMY, new AddMemberCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB
            + PHONE_DESC_BOB
            + EMAIL_DESC_BOB
            + MATRIC_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB
            + PHONE_DESC_BOB
            + EMAIL_DESC_BOB
            + VALID_MATRIC_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC
            + PHONE_DESC_BOB
            + EMAIL_DESC_BOB
            + INVALID_MATRIC_DESC, Name.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY
            ...
            + MATRIC_DESC_BOB
            + TAG_DESC_HUSBAND
            + TAG_DESC_FRIEND, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddMemberCommand.MESSAGE_USAGE));
    }
}
