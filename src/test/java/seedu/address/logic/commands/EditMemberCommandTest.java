...
public class EditMemberCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        String expectedMessage = String.format(EditMemberCommand.MESSAGE_EDIT_PERSON_SUCCESS,
    ...
    public void equals() {
        ...
        assertNotEquals(standardCommand, new EditMemberCommand(INDEX_SECOND_PERSON, DESC_AMY));

        // different descriptor -> returns false
        assertNotEquals(standardCommand, new EditMemberCommand(INDEX_FIRST_PERSON, DESC_BOB));
    }
    ...
    public void toStringMethod() {
        ...
        EditMemberCommand editMemberCommand = new EditMemberCommand(index, editPersonDescriptor);
        String expected = EditMemberCommand.class.getCanonicalName()
            + "{index="
            + index
