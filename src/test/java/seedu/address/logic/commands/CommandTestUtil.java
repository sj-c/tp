...
public class CommandTestUtil {
    ...
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_MATRICULATIONNUMBER + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_MATRICULATIONNUMBER + VALID_ADDRESS_BOB;
