...
public class EditMemberCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
        ...
        +
        "overwritten by the input values.\n"
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof EditMemberCommand otherEditMemberCommand)) {
            return false;
        }

        return index.equals(otherEditMemberCommand.index)
            && editPersonDescriptor.equals(otherEditMemberCommand.editPersonDescriptor);
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this).add("index", index).add("editPersonDescriptor",
            editPersonDescriptor).toString();
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(name, otherEditPersonDescriptor.name) && Objects.equals(phone,
                otherEditPersonDescriptor.phone) && Objects.equals(email,
                otherEditPersonDescriptor.email) && Objects.equals(matriculationNumber,
                otherEditPersonDescriptor.matriculationNumber) && Objects.equals(tags,
                otherEditPersonDescriptor.tags);
        }

        @Override
        public String toString() {
            return new ToStringBuilder(this).add("name", name).add("phone", phone).add("email", email).add(
                "matriculationNumber", matriculationNumber).add("tags", tags).toString();
        }
    }
}
